...
class GRUMT(nn.Module):
    ...
    def __init__(self, input_size, hidden_size, output_size, max_length, device, dropout_p=0.1):
        ...
        self.encoder_rnn = nn.GRU(hidden_size, hidden_size) # Problem 1

        # Decoder 부분
        # <ToDo>: decoder를 GRU로 정의하세요.
        self.decoder_rnn = nn.GRU(hidden_size, hidden_size) # Problem 1
...
valid_loader = make_data_loader(valid_file_path, eng_dic, kor_dic, max_len, 1) # Problem 2
